package dev.alexfossa204.starbank.microservice.config.security.provider;
...
import static dev.alexfossa204.starbank.microservice.config.security.constant.JwtTokenConfigurationConstant.*;
