package dev.alexfossa204.starbank.authorization.config.kafka;
...
public class KafkaTopicConfig {
    ...
    public NewTopic setVerificationCodeAsUsedTopic() {
        return new NewTopic(KafkaConstant.SET_VERIFICATION_CODE_AS_USED_TOPIC, KafkaConstant.DEFAULT_PARTITION_FACTOR, KafkaConstant.DEFAULT_REPLICATION_FACTOR);
    }
