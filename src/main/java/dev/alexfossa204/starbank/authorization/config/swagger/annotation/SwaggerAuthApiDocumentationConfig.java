package dev.alexfossa204.starbank.authorization.config.swagger.annotation;
...
@SwaggerLoginResponseDocumentationConfig
@ApiResponses(value = {
...
public @interface SwaggerAuthApiDocumentationConfig {
}
