...
import dev.alexfossa204.starbank.microservice.config.security.filter.CorsFilter;
import dev.alexfossa204.starbank.microservice.config.security.filter.JwtAccessDeniedHandler;
import dev.alexfossa204.starbank.microservice.config.security.filter.JwtAuthenticationEntryPoint;
import dev.alexfossa204.starbank.microservice.config.security.provider.JwtTokenProvider;
import dev.alexfossa204.starbank.microservice.controller.impl.AuthApiController;
...
import dev.alexfossa204.starbank.microservice.service.impl.BaseAuthenticationManagerService;
